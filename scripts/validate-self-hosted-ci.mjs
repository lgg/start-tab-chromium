...
const regressionCommands = [
  ...
  "node scripts/run-round33-fixtures.mjs",
  "node scripts/validate-round33-static.mjs",
  "node scripts/run-round34-fixtures.mjs",
  "node scripts/validate-round34-static.mjs",
  "node scripts/run-round35-fixtures.mjs",
  "node scripts/validate-round35-static.mjs",
  "node scripts/run-round36-fixtures.mjs",
  "node scripts/validate-round36-static.mjs",
  "node scripts/run-round37-fixtures.mjs",
  "node scripts/validate-round37-static.mjs",
  "node scripts/run-round38-fixtures.mjs",
  "node scripts/validate-round38-static.mjs",
  "node scripts/run-round39-fixtures.mjs",
